...
- Array operations: [`example/arrays.c`](     https://github.com/kal39/microcompute/blob/master/example/arrays.c   ) 
- Mandelbrot renderer: [`example/mandelbrot.c`](     https://github.com/kal39/microcompute/blob/master/example/mandelbrot.c   ) 
